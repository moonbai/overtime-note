...
fun BackupSettingsPage(
    ...
    var webdavUrl by remember { mutableStateOf(allConfigs.find { it.key == "webdav_url" }?.value ?: "") }
    var webdavUsername by remember { mutableStateOf(allConfigs.find { it.key == "webdav_username" }?.value ?: "") }
    var webdavPassword by remember { mutableStateOf(allConfigs.find { it.key == "webdav_password" }?.value ?: "") }
    var webdavPath by remember { mutableStateOf(allConfigs.find { it.key == "webdav_path" }?.value ?: "/overtime_backup/") }
